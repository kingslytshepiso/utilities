...
This template is designed to be extended. Available variants:

### Available

- **Basic Template** (current) - ✅ Clean starter with theming and utilities
- **Auth Template** - See `variant-auth` branch for Supabase authentication
- **Full Template** - See `variant-full` branch for all features
