      ...
      <ScrollView contentContainerStyle={[gutters.padding.lg]}>
        ...
        <ThemedView style={[gutters.marginBottom.xl]}>
          <Button
            ...
            onPress={() => router.back()}
            icon="arrow-left"
            style={[{ alignSelf: "flex-start" }, gutters.marginBottom.md]}
          >
            Back to Home
          </Button>
        ...
        <Card style={[gutters.marginBottom.md, rounded.md, shadow.sm]}>
          <Card.Content>
            ...
            <ThemedText style={[gutters.marginBottom.sm]}>
              ...
              {"\n"}
              Modify <ThemedText type="defaultSemiBold">
                app.json
              </ThemedText>{" "}
              with your app name and settings.
            </ThemedText>
            ...
            <ThemedText>
              ...
              {"\n"}
              Import from{" "}
              <ThemedText type="defaultSemiBold">@/utils</ThemedText> for
